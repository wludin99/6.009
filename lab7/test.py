...
# Tests for checking the str and repr implementations,
# with and without parenthesization:


class Test_0_Display(unittest.TestCase):
    def test_00(self):
        exp = lab.Add(lab.Num(0), lab.Var('x'))
        expected = ("Add(Num(0), Var('x'))", '0 + x')
        self.assertEqual(symbol_rep(safe_eval(expected[0])), symbol_rep(safe_eval(repr(exp))))
        self.assertEqual(expected[1], str(exp))
...
# This tests that your implementation of the dunder methods is correct:


class Test_1_Combine(unittest.TestCase):
    def test_00(self):
        result = 0 + lab.Var('x')
...
# Checks your implementation of the deriv() method
# for each of the BinOp variants:
...
# Checks your implementation of the simplify() method
# for each of the BinOp variants:
...
class Test_3_Simplify(unittest.TestCase):
    ...
    def test_02(self):
        ...
        # print('unsimplified:', read_expected('106_in.pyobj'))
        # print('result:', result)
        # print('expected:', expected)
        # result_str = result.__str__()
        # expected_str = expected.__str__()
        # print(result_str[770:800])
        # print(expected_str[770:800])
        self.assertEqual(symbol_rep(expected), symbol_rep(result))

# Checks your implementation of the eval() method
# for each of the BinOp variants:
...
# Checks your implementation of the sym() function
# It does not check the suggested tokenize() and parse()
# helper functions individually though!
